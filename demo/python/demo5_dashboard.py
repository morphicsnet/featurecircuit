...
from python.repro.protocol_manifest import write_protocol_manifest  # noqa: E402
...
def main(config_path: str = "configs/demo5_dashboard.yaml") -> None:
    ...
    out_dir = create_run_dir(base_dir="runs/investor")
...
if __name__ == "__main__":
    main(sys.argv[1] if len(sys.argv) > 1 else "configs/demo5_dashboard.yaml")

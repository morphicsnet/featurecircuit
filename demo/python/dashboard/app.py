...
def _sidebar_controls(cfg: Dict[str, Any]) -> Tuple[Dict[str, Any], Dict[str, Optional[str]], Dict[str, Any]]:
    ...
    baseline_dir = runs_cfg.get("baseline_dir", "runs/baseline")
    ensemble_dir = runs_cfg.get("ensemble_dir", "runs/ensemble")
    spike_dir = runs_cfg.get("spike_hypergraph_dir", "runs/spike_hypergraph")
    causal_dir = runs_cfg.get("causal_dir", "runs/causal")

...
def main(config_path: str = "configs/demo1_baseline.yaml") -> None:
    ...
    write_feature_space(
        run_dir,
        {
            ...
            "schema_version": 1,
            "feature_space_id": "demo1.sae_features",
            "feature_space_type": "sae",
            "producer": "demo1_baseline",
            "producer_version": "v1",
            "model_id": model_name,
            "layer_map": {str(layer_index): "sae"},
...
if __name__ == "__main__":
    main(sys.argv[1] if len(sys.argv) > 1 else "configs/demo1_baseline.yaml")

...
The Rust exporter in `core/nsi_core/src/hypergraph.rs` writes a minimal, deterministic JSON structure:
...
store.export_hif("runs/spike_hypergraph/<run_tag>/hypergraph.hif.json")
```

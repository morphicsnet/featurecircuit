...
- Setup
  ...
  - Artifacts baseline directory under [runs/](runs/).
- Procedure
...
- Artifacts (manual, if recorded)
  - `runs/baseline/<run_tag>/metrics_spec.json`
  - `runs/baseline/<run_tag>/locked_acceptance.yaml`
- Acceptance Criteria
  - [ ] All metric definitions present in [METRICS.md](METRICS.md), including monosemantic rate and STII reporting.
  - [ ] Locked thresholds serialized to `runs/baseline/<run_tag>/locked_acceptance.yaml` if tracked.
...
- Artifacts
  - `runs/baseline/<run_tag>/poly_hist.png`
  - `runs/baseline/<run_tag>/metrics.json`
  - `runs/baseline/<run_tag>/config.yaml`
- Acceptance Criteria
...
- Artifacts
  - `runs/ensemble/<run_tag>/poly_hist_single.png`
  - `runs/ensemble/<run_tag>/poly_hist_intersection.png`
  - `runs/ensemble/<run_tag>/poly_hist_dual.png`
  - `runs/ensemble/<run_tag>/metrics_single.json`
  - `runs/ensemble/<run_tag>/metrics_intersection.json`
  - `runs/ensemble/<run_tag>/compare.json`
  - `runs/ensemble/<run_tag>/config.yaml`
- Acceptance Criteria
  - [ ] Intersection method and threshold recorded in `runs/ensemble/<run_tag>/config.yaml`.
...
- Artifacts
  - `runs/spike_hypergraph/<run_tag>/hypergraph.hif.json`
  - `runs/spike_hypergraph/<run_tag>/metrics_hyperedges.json`
  - `runs/spike_hypergraph/<run_tag>/poly_hist_hyperedges.png`
  - `runs/spike_hypergraph/<run_tag>/edge_keys.json`
  - `runs/spike_hypergraph/<run_tag>/config.yaml`
- Acceptance Criteria
...
- Artifacts
  - `runs/causal/<run_tag>/stii_values.json`
  - `runs/causal/<run_tag>/acdc_minimal_circuit.json`
  - `runs/causal/<run_tag>/fairness_report.json`
  - `runs/causal/<run_tag>/hypergraph_stii.hif.json`
  - `runs/causal/<run_tag>/config.yaml`
- Acceptance Criteria
...
- Artifacts
  - `runs/investor/<run_tag>/dashboard_metrics.json`
  - `runs/investor/<run_tag>/dashboard_summary.md`
  - `runs/investor/<run_tag>/*.png` (figures referenced by the summary)
- Acceptance Criteria
